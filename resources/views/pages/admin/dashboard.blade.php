<x-common.admin.container>
    <div class="row">
        <x-admin.count-card :title="'For Sale'" :count="$total_sale" :icon="'fa fa-home'"/>

        <x-admin.count-card :title="'For Rent'" :count="$total_rental" :icon="'fa fa-building'"/>

        <x-admin.count-card :title="'Total Users'" :count="$total_user" :icon="'fa fa-user'"/>

        <x-admin.count-card :title="'Total Deals'" :count="$total_transaction" :icon="'fa fa-handshake-o'"/>
