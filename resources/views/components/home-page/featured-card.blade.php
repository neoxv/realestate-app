    ...
    <div class="property-box-7">
        <div class="property-thumbnail">
            <a href="{{route('detail',['property'=>$property->id])}}" class="property-img">
                ...
                <img src="{{asset(count($property->documents) > 0 ?'img/properties/'. $property->documents->first()->filename:'img/default.png')}}" alt="property-box-7" class="img-fluid" style="width: 100%; height: 15vw; object-fit: cover;">
            </a>
        </div>
        <div class="detail" >
            <h1 class="title">
