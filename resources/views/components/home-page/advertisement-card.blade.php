                    ...
                    <div class="property-box-4">
                        <div class="thumbnail_inner">
                            <div class="thumbnail">
                                <a href="#">
                                    @if($ad != null)
                                        <img src="{{asset(count($ad->documents) > 0 ?'img/ads/'. $ad->documents->first()->filename:'default.png')}}" alt="property-box-4" class="img-fluid" style="width: 300px; height: 300px; object-fit: cover;">
                                    @else
