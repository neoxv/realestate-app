                ...
                <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide mb-60">
                    ...
                    <div class="carousel-inner">
                        <div class="active item carousel-item" data-slide-number="0">
                            <img src="assets/img/property/img-16.jpg" class="img-fluid" alt="properties-photo">
                        </div>
                    ...
                    <ul class="carousel-indicators sp-2 smail-properties list-inline nav nav-justified ">
                        <li class="list-inline-item active">
                            <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/property/img-16.jpg" class="img-fluid" alt="properties-photo-smale">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-1" data-slide-to="1" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/property/img-17.jpg" class="img-fluid" alt="properties-photo-smale">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-2" data-slide-to="2" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/property/img-18.jpg" class="img-fluid" alt="properties-photo-smale">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-4" data-slide-to="3" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/property/img-19.jpg" class="img-fluid" alt="properties-photo-smale">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a id="carousel-selector-5" data-slide-to="4" data-target="#propertiesDetailsSlider">
                                <img src="assets/img/property/img-20.jpg" class="img-fluid" alt="properties-photo-smale">
                            </a>
                        </li>
                    </ul>
                </div>
                            ...
                            <div class="property-box-7">
                                <div class="property-thumbnail">
                                    <a href="properties-details.html" class="property-img">
                                        ...
                                        <img src="assets/img/property/img-4.jpg" alt="property-box-7" class="img-fluid">
                                    </a>
                                </div>
                                <div class="detail">
                                    <h1 class="title">
                            ...
                            <div class="property-box-7">
                                <div class="property-thumbnail">
                                    <a href="properties-details.html" class="property-img">
                                        ...
                                        <div class="price-box"><span>$850.00</span> Per night</div>
                                        <img src="assets/img/property/img-5.jpg" alt="property-box-7" class="img-fluid">
                                    </a>
                                </div>
                                <div class="detail">
                                    <h1 class="title">
